...
const Page = () => {
  return (
    <Layout>
      <div className="w-full py-8 md:pt-0 px-2 h-full xl:h-screen">
        <PageTitle main="Your Workspace" sub="Welcome,xxx" />
        <h1 className="px-4 font-semibold text-base mb-8">Overview</h1>
        <div className="grid grid-cols-1 gap-y-8 px-4 md:grid-cols-2 md:gap-4 lg:gap-x-10 xl:gap-x-20 xl:w-10/12">
          <div className="shadow-md rounded-b-lg">
            ...
            <div className=" rounded-lg h-44">
              ...
              <div className="bg-gray-200  flex items-start justify-center leading-4 text-sm font-medium text-[#000000]/50">
                <p className="px-2 mt-4 lg:px-0">
