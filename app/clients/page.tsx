  ...
  return (
    <Layout>
      <div className="h-full 2xl:h-screen">
        ...
        <div className="bg-gray-200 rounded-md px-4  pb-16">
          <div className="flex flex-col md:flex-row  md:w-full gap-3 xl:gap-6 md:items-center md:flex-1">
            <Input
              ...
              title="search"
            />
            <Link href="/addClient" className="w-fit md:w-1/5 lg:w-1/5">
              <Button
                type="submit"
          ...
          <div className="mt-2 w-full overflow-auto scrollbar-hide">
            <table className=" ">
